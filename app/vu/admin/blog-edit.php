...
<div class="row">
  <div class="col-md-12">
    <div class="card card-primary">
      ...
      <div class="card-body"> 
       <?php echo form_open_multipart('admin/blog/update', array('id'=>'blogupdate')); ?>
       <input type="hidden" name="hid" id="hid"  value="<?php echo $blog->blog_id; ?>">
        ...
        <div class="col-md-6">
         	<div class="form-group">
                ...
                {
                  ?>
                  <img src="<?php echo base_url($blog->blogo_photo); ?>" class="col-sm-1">
                  <?php
                }
                ?>
                <div class="col-sm-6">
                  <input type="file" name="blogo_photo" id="blogo_photo" placeholder="Include Photo" >
                </div>
            </div>
        </div>
         <div class="col-md-12">
            <div class="form-group">
           		<textarea id="ckeditor" name="ckeditor" rows="10" cols="100" tabindex="6"><?php echo $blog->blog_content; ?></textarea> 
           </div>
         </div> 
         <div class="col-md-12">
         	<div class="form-group">
                ...
                <div class="col-sm-4">
           			<textarea id="meta_tag" name="meta_keywords" class="form-control"  rows="5"  tabindex="7"><?php echo $blog->meta_keywords; ?></textarea> 
                </div>
