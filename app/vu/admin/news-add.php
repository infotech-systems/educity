...
<div class="row">
  <div class="col-md-12">
    ...
    <div id="loading"></div>
      ...
      <div class="card-body"> 
       <?php echo form_open_multipart('admin/news/adds', array('id'=>'newsadd')); ?>	
        <div class="col-md-6">
            <div class="form-group">
              <label for="Name" class="col-sm-4">Name</label>
              <div class="col-sm-8">
              	 <input type="text" name="newsname" id="newsname" tabindex="1" class="form-control" value="" maxlength="50" autofocus autocomplete="off">
               </div>
            </div>
            <div class="form-group">
         ...
         <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="col-sm-8">
              	 <input type="text" name="publisher" id="publisher" tabindex="1" class="form-control" value="" maxlength="50" autofocus autocomplete="off">
               </div>
            </div>
         	 <div class="form-group">
              <label for="Date" class="col-sm-4">Date</label>
              <div class="col-sm-8">
              	 <input type="text" name="news_dt" id="news_dt"  class="form-control" value="" tabindex="2" autocomplete="off">
               </div>
            </div>
