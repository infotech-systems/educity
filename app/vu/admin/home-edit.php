...
<div class="row">
  <div class="col-md-12">
    ...
    <div id="loading"></div>
      ...
      <div class="card-body"> 
       <?php echo form_open_multipart('admin/home/update', array('id'=>'homeupdate')); ?>	
       <input type="hidden" name="hid" id="hid" value="<?php echo $homes->home_id; ?>">   
        <div class="col-md-12">
            <div class="form-group">
              <label for="Title" class="col-sm-4">Title</label>
              <div class="col-sm-8">
              	 <input type="text" name="homename" id="homename" tabindex="1" class="form-control" value="<?php echo $homes->home_title; ?>" >
               </div>
            </div>
         </div> 
         <div class="col-md-12">
            <textarea id="ckeditor" name="ckeditor" rows="10" cols="100">   
                <?php echo $homes->home_content; ?>                                        
             </textarea> 
         </div> 
      </div>
