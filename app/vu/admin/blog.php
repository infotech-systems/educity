          ...
          <tr>
            ...
            <th>
              <div class="btn-group float-right">
                <a href="<?php echo site_url('admin/blog/add/'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i></a>
              </div> 
            </th>
          </tr>
          <?php
          if($blogs)
          {
              foreach($blogs as $blog): 
                ...
                <tr>
                    ...
                    <td>
                    <div class="btn-group float-right">
                        <a href="<?php echo site_url('admin/blog/edit/'.md5($id)); ?>" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i></a>
